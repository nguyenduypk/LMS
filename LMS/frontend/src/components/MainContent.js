  ...
  return (
    <section className="banner modern-banner" id="banner">
      <div className="banner__content">
        ...
        <p className="banner__desc">Một cách hiệu quả để quản lý lớp học</p>
        <button className="btn btn-primary banner__cta modern-cta">Tham gia ngay</button>
...
function Partners() {
  return (
    <section className="partners modern-partners" id="partners">
      <h2 className="partners__title">Đối tác tin cậy</h2>
  ...
  return (
    <>
      <main>
        ...
        {/* Navigation Button between Features and Partners */}
        <div className="section-nav-container">
          <button 
            className="section-nav-button"
        ...
        {/* Navigation Button between Partners and Stats */}
        <div className="section-nav-container">
          <button 
            className="section-nav-button"
