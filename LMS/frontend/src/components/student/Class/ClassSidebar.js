...
function ClassSidebar({ classInfo }) {
  ...
  const getCurrentTab = () => {
    ...
    if (location.pathname.includes('/materials') || location.pathname.includes('/documents/')) return 'materials';
    return 'announcement';
  };
    ...
    <>
      <aside className="class-sidebar">
        <div className="class-sidebar-header">
          ...
          <div className="class-sidebar-code">Mã lớp: {classInfo.code.toUpperCase()}</div>
